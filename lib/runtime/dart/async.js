dart_library.library('dart/async', null, /* Imports */[
  ...
  /**
   * @param {core.Function} errorHandler
   * @param {Zone} zone
  ...
  let Stream$ = dart.generic(function(T) {
    class Stream extends core.Object {
      ...
      /**
       * @param {core.Duration} period
       * @param {function(?number):*=} computation
       * @return {Stream}
       */
      ...
      /**
       * @param {Stream} source
       * @param {function(EventSink):EventSink} mapSink
       * @return {Stream}
       */
      ...
      /**
       * @param {{onListen: (function(StreamSubscription)|undefined), onCancel: (function(StreamSubscription)|undefined)}=} opts
       * @return {Stream}
       */
      ...
      /**
       * @param {core.Function} onError
       * @param {{test: (function(*):?boolean|undefined)}=} opts
       * @return {Stream}
       */
      ...
      /**
       * @param {function(*):core.Iterable} convert
       * @return {Stream}
       */
      expand(convert) {
      ...
      /**
       * @param {StreamTransformer} streamTransformer
       * @return {Stream}
       */
      ...
      /**
       * @param {function(*):?boolean} test
       * @param {{defaultValue: (function():core.Object|undefined)}=} opts
       * @return {Future}
       */
      ...
      /**
       * @param {core.Duration} timeLimit
       * @param {{onTimeout: (function(EventSink)|undefined)}=} opts
       * @return {Stream}
       */
  ...
  let _StreamImpl$ = dart.generic(function(T) {
    class _StreamImpl extends Stream$(T) {
      /** @constructor @extends {Stream} */
      _StreamImpl() {
        super.Stream();
      }
      /**
       * @param {function(*)} onData
       * @param {{onError: (core.Function|undefined), onDone: (function()|undefined), cancelOnError: (?boolean|undefined)}=} opts
  ...
  let _ControllerStream$ = dart.generic(function(T) {
    class _ControllerStream extends _StreamImpl$(T) {
      /**
       * @constructor
       * @param {_StreamControllerLifecycle} _controller
  ...
  let _BroadcastStream$ = dart.generic(function(T) {
    class _BroadcastStream extends _ControllerStream$(T) {
      /**
       * @constructor
       * @param {_StreamControllerLifecycle} controller
  ...
  let _BufferingStreamSubscription$ = dart.generic(function(T) {
    class _BufferingStreamSubscription extends core.Object {
      ...
      /** @param {_PendingEvents} pendingEvents */
  ...
  let _BroadcastStreamController$ = dart.generic(function(T) {
    class _BroadcastStreamController extends core.Object {
      /**
       * @constructor
       * @param {function():*} _onListen
       * @param {function():*} _onCancel
       * @return {_BroadcastStreamController}
       */
      ...
      /** @param {_BroadcastSubscription} subscription */
      ...
      /**
       * @param {Stream} stream
       * @param {{cancelOnError: (?boolean|undefined)}=} opts
       * @return {Future}
       */
      ...
      /** @param {function(_BufferingStreamSubscription)} action */
  ...
  class DeferredLibrary extends core.Object {
     ...
     * @param {{uri: (string|undefined)}=} opts
  ...
  let Future$ = dart.generic(function(T) {
    class Future extends core.Object {
      ...
      /**
       * @param {core.Iterable} futures
       * @param {{eagerError: (?boolean|undefined), cleanUp: (function(*)|undefined)}=} opts
       * @return {Future}
       */
  ...
  let _AsyncCompleter$ = dart.generic(function(T) {
    class _AsyncCompleter extends _Completer$(T) {
      /** @constructor @extends {_Completer} */
      _AsyncCompleter() {
        super._Completer();
      }
      /** @param {*=} value */
  ...
  class _FutureListener extends core.Object {
     ...
     * @param {core.Function} errorCallback
  ...
  let _Future$ = dart.generic(function(T) {
    class _Future extends core.Object {
      ...
      /**
       * @param {function(*):*} f
       * @param {{onError: (core.Function|undefined)}=} opts
       * @return {Future}
       */
      then(f, opts) {
      ...
      /** @param {_FutureListener} listener */
      ...
      /**
       * @param {_Future} source
       * @param {_FutureListener} listeners
       */
      ...
      /**
       * @param {core.Duration} timeLimit
       * @param {{onTimeout: (function():*|undefined)}=} opts
       * @return {Future}
       */
      timeout(timeLimit, opts) {
        let onTimeout = opts && 'onTimeout' in opts ? opts.onTimeout : null;
  ...
  let StreamTransformer$ = dart.generic(function(S, T) {
    class StreamTransformer extends core.Object {
      /**
       * @param {function(Stream, ?boolean):StreamSubscription} transformer
      ...
      /**
       * @param {{handleData: (function(*, EventSink)|undefined), handleError: (function(core.Object, core.StackTrace, EventSink)|undefined), handleDone: (function(EventSink)|undefined)}=} opts
       * @return {StreamTransformer}
       */
  ...
  let StreamController$ = dart.generic(function(T) {
    class StreamController extends core.Object {
      /**
       * @param {{onListen: (function()|undefined), onPause: (function()|undefined), onResume: (function()|undefined), onCancel: (function():*|undefined), sync: (?boolean|undefined)}=} opts
      ...
      /**
       * @param {{onListen: (function()|undefined), onCancel: (function()|undefined), sync: (?boolean|undefined)}=} opts
       * @return {StreamController}
       */
  ...
  let _AsyncStreamController$ = dart.generic(function(T) {
    class _AsyncStreamController extends dart.mixin(_StreamController$(T), _AsyncStreamControllerDispatch$(T)) {
       ...
       * @constructor
       * @param {function()} _onListen
       * @param {function()} _onPause
       * @param {function()} _onResume
       * @param {function():*} _onCancel
  ...
  let _StreamSinkWrapper$ = dart.generic(function(T) {
    class _StreamSinkWrapper extends core.Object {
      /**
       * @constructor
       * @param {StreamController} _target
  ...
  let _StreamControllerAddStreamState$ = dart.generic(function(T) {
    class _StreamControllerAddStreamState extends _AddStreamState$(T) {
      /**
       * @constructor
       * @param {_StreamController} controller
       * @param {Stream} source
       * @param {?boolean} cancelOnError
  ...
  let _GeneratedStreamImpl$ = dart.generic(function(T) {
    class _GeneratedStreamImpl extends _StreamImpl$(T) {
      /**
       * @constructor
       * @param {function():_PendingEvents} _pending
  ...
  class _StreamImplEvents extends _PendingEvents {
    /** @constructor @extends {_PendingEvents} */
    _StreamImplEvents() {
  ...
  class _BroadcastLinkedList extends core.Object {
    ...
    /** @param {_BroadcastLinkedList} newNext */
  ...
  let _AsBroadcastStream$ = dart.generic(function(T) {
    class _AsBroadcastStream extends Stream$(T) {
      /**
       * @constructor
       * @param {Stream} _source
       * @param {function(StreamSubscription)} onListenHandler
       * @param {function(StreamSubscription)} onCancelHandler
  ...
  let _BroadcastSubscriptionWrapper$ = dart.generic(function(T) {
    class _BroadcastSubscriptionWrapper extends core.Object {
      /**
       * @constructor
       * @param {_AsBroadcastStream} _stream
   ...
   * @param {function(*, core.StackTrace):*} onError
   */
  ...
  let _ForwardingStreamSubscription$ = dart.generic(function(S, T) {
    class _ForwardingStreamSubscription extends _BufferingStreamSubscription$(T) {
      /**
       * @constructor
       * @param {_ForwardingStream} _stream
       * @param {function(*)} onData
       * @param {core.Function} onError
       * @param {function()} onDone
       * @param {?boolean} cancelOnError
  ...
  let _ExpandStream$ = dart.generic(function(S, T) {
    class _ExpandStream extends _ForwardingStream$(S, T) {
       ...
       * @constructor
       * @param {Stream} source
       * @param {function(*):core.Iterable} expand
  ...
  let _SinkTransformerStreamSubscription$ = dart.generic(function(S, T) {
    class _SinkTransformerStreamSubscription extends _BufferingStreamSubscription$(T) {
       ...
       * @constructor
       * @param {Stream} source
       * @param {function(EventSink):EventSink} mapper
       * @param {function(*)} onData
       * @param {core.Function} onError
       * @param {function()} onDone
       * @param {?boolean} cancelOnError
  ...
  let _StreamSinkTransformer$ = dart.generic(function(S, T) {
    class _StreamSinkTransformer extends core.Object {
      /**
       * @constructor
       * @param {function(EventSink):EventSink} _sinkMapper
  ...
  let _HandlerEventSink$ = dart.generic(function(S, T) {
    class _HandlerEventSink extends core.Object {
      /**
       * @constructor
       * @param {function(*, EventSink)} _handleData
       * @param {function(core.Object, core.StackTrace, EventSink)} _handleError
       * @param {function(EventSink)} _handleDone
       * @param {EventSink} _sink
  ...
  let _StreamSubscriptionTransformer$ = dart.generic(function(S, T) {
    class _StreamSubscriptionTransformer extends core.Object {
      /**
       * @constructor
       * @param {function(Stream, ?boolean):StreamSubscription} _transformer
  ...
  class ZoneSpecification extends core.Object {
    /**
     * @param {{handleUncaughtError: (function(Zone, ZoneDelegate, Zone, *, core.StackTrace):*|undefined), run: (function(Zone, ZoneDelegate, Zone, function():*):*|undefined), runUnary: (function(Zone, ZoneDelegate, Zone, function(*):*, *):*|undefined), runBinary: (function(Zone, ZoneDelegate, Zone, function(*, *):*, *, *):*|undefined), registerCallback: (function(Zone, ZoneDelegate, Zone, function():*):function():*|undefined), registerUnaryCallback: (function(Zone, ZoneDelegate, Zone, function(*):*):function(*):*|undefined), registerBinaryCallback: (function(Zone, ZoneDelegate, Zone, function(*, *):*):function(*, *):*|undefined), errorCallback: (function(Zone, ZoneDelegate, Zone, core.Object, core.StackTrace):AsyncError|undefined), scheduleMicrotask: (function(Zone, ZoneDelegate, Zone, function():*)|undefined), createTimer: (function(Zone, ZoneDelegate, Zone, core.Duration, function()):Timer|undefined), createPeriodicTimer: (function(Zone, ZoneDelegate, Zone, core.Duration, function(Timer)):Timer|undefined), print: (function(Zone, ZoneDelegate, Zone, string)|undefined), fork: (function(Zone, ZoneDelegate, Zone, ZoneSpecification, core.Map):Zone|undefined)}=} opts
  ...
  class _RootZone extends _Zone {
    ...
    /**
     * @param {function():*} f
     * @param {{runGuarded: (?boolean|undefined)}=} opts
     * @return {function():*}
     */
    bindCallback(f, opts) {
    ...
    /**
     * @param {{specification: (ZoneSpecification|undefined), zoneValues: (core.Map|undefined)}=} opts
     * @return {Zone}
     */
    fork(opts) {
  ...
  class _ZoneDelegate extends core.Object {
    ...
    /**
     * @param {Zone} zone
     * @param {ZoneSpecification} specification
     * @param {core.Map} zoneValues
     * @return {Zone}
     */
  ...
  class _RootZoneSpecification extends core.Object {
    /** @return {function(Zone, ZoneDelegate, Zone, *, core.StackTrace):*} */
    get handleUncaughtError() {
      return _rootHandleUncaughtError;
    }
    /** @return {function(Zone, ZoneDelegate, Zone, function():*):*} */
    get run() {
      return _rootRun;
    }
    /** @return {function(Zone, ZoneDelegate, Zone, function(*):*, *):*} */
    ...
    /** @return {function(Zone, ZoneDelegate, Zone, function():*):function():*} */
    ...
    /** @return {function(Zone, ZoneDelegate, Zone, core.Object, core.StackTrace):AsyncError} */
    get errorCallback() {
    ...
    /** @return {function(Zone, ZoneDelegate, Zone, core.Duration, function()):Timer} */
    get createTimer() {
      return _rootCreateTimer;
    }
    /** @return {function(Zone, ZoneDelegate, Zone, core.Duration, function(Timer)):Timer} */
    get createPeriodicTimer() {
      return _rootCreatePeriodicTimer;
    }
    /** @return {function(Zone, ZoneDelegate, Zone, string)} */
    get print() {
      return _rootPrint;
    }
    /** @return {function(Zone, ZoneDelegate, Zone, ZoneSpecification, core.Map):Zone} */
    get fork() {
      return _rootFork;
    }
  }
  ...
  dart.defineLazyProperties(_RootZone, {
    ...
    /** @param {core.Map} __rootMap */
    set _rootMap(_) {}
  });
  /**
   * @param {function():*} body
   * @param {{zoneValues: (core.Map|undefined), zoneSpecification: (ZoneSpecification|undefined), onError: (core.Function|undefined)}=} opts
   */
