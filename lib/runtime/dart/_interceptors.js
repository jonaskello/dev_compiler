dart_library.library('dart/_interceptors', null, /* Imports */[
  ...
  let JSArray$ = dart.generic(function(E) {
    ...
    class JSArray extends core.Object {
      ...
      /** @param {core.Iterable} collection */
  ...
  let JSMutableArray$ = dart.generic(function(E) {
    class JSMutableArray extends JSArray$(E) {
      /**
       * @constructor @extends {JSArray}
       * @implements {JSMutableIndexable}
       */
      JSMutableArray() {
        super.JSArray();
      }
  ...
  class JSString extends Interceptor {
    ...
    /**
     * @param {core.Pattern} from
     * @param {function(core.Match):string} convert
     * @return {string}
     */
    ...
    /**
     * @param {core.Pattern} from
     * @param {{onMatch: (function(core.Match):string|undefined), onNonMatch: (function(string):string|undefined)}=} opts
     * @return {string}
     */
  ...
  class UnknownJavaScriptObject extends JavaScriptObject {
    /**
     * @constructor
     * @return {UnknownJavaScriptObject}
     */
