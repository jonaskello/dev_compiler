dart_library.library('dart/_native_typed_data', null, /* Imports */[
  ...
  class NativeFloat32x4List extends dart.mixin(core.Object, collection.ListMixin$(typed_data.Float32x4), _internal.FixedLengthListMixin$(typed_data.Float32x4)) {
    ...
    /**
     * @constructor
     * @param {NativeFloat32List} _storage
     * @return {NativeFloat32x4List}
     */
    ...
    /**
     * @param {?number} index
     * @param {typed_data.Float32x4} value
     */
    set(index, value) {
      this[_checkIndex](index, this.length);
  ...
  class NativeInt32x4List extends dart.mixin(core.Object, collection.ListMixin$(typed_data.Int32x4), _internal.FixedLengthListMixin$(typed_data.Int32x4)) {
    ...
    /**
     * @constructor
     * @param {typed_data.Int32List} storage
     * @return {NativeInt32x4List}
     */
    _externalStorage(storage) {
      this[_storage] = storage;
    ...
    /**
     * @param {?number} index
     * @param {typed_data.Int32x4} value
     */
    set(index, value) {
      this[_checkIndex](index, this.length);
      this[_storage].set(dart.notNull(index) * 4 + 0, value.x);
  ...
  class NativeFloat64x2List extends dart.mixin(core.Object, collection.ListMixin$(typed_data.Float64x2), _internal.FixedLengthListMixin$(typed_data.Float64x2)) {
    ...
    /**
     * @constructor
     * @param {NativeFloat64List} _storage
     * @return {NativeFloat64x2List}
     */
    _externalStorage(storage) {
      this[_storage] = storage;
    ...
    /**
     * @param {?number} index
     * @param {typed_data.Float64x2} value
     */
    set(index, value) {
      this[_checkIndex](index, this.length);
  ...
  class NativeTypedData extends core.Object {
    /**
     * @constructor @extends {core.Object}
     * @implements {typed_data.TypedData}
     */
    NativeTypedData() {
      this.buffer = null;
      this.lengthInBytes = null;
  ...
  class NativeByteData extends NativeTypedData {
    ...
    /**
     * @param {typed_data.ByteBuffer} buffer
     * @param {?number} offsetInBytes
     * @param {?number} length
     * @return {NativeByteData}
     */
     ...
     * @param {typed_data.Endianness=} endian
     * @return {?number}
     */
  ...
  class NativeTypedArray extends NativeTypedData {
    /**
     * @constructor @extends {NativeTypedData}
  ...
  class NativeFloat32x4 extends core.Object {
    ...
    /**
     * @param {typed_data.Float32x4} other
     * @return {typed_data.Float32x4}
     */
    ['+'](other) {
    ...
    /**
     * @param {typed_data.Float32x4} lowerLimit
     * @param {typed_data.Float32x4} upperLimit
     * @return {typed_data.Float32x4}
     */
  ...
  class NativeInt32x4 extends core.Object {
    ...
    /**
     * @param {typed_data.Int32x4} other
     * @return {typed_data.Int32x4}
     */
    ['|'](other) {
    ...
    /**
     * @param {typed_data.Float32x4} trueValue
     * @param {typed_data.Float32x4} falseValue
     * @return {typed_data.Float32x4}
     */
  ...
  class NativeFloat64x2 extends core.Object {
    ...
    /**
     * @param {typed_data.Float64x2} other
     * @return {typed_data.Float64x2}
     */
    ['+'](other) {
    ...
    /**
     * @param {typed_data.Float64x2} lowerLimit
     * @param {typed_data.Float64x2} upperLimit
     * @return {typed_data.Float64x2}
     */
    clamp(lowerLimit, upperLimit) {
      let _lx = lowerLimit.x;
