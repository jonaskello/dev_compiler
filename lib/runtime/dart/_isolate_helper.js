dart_library.library('dart/_isolate_helper', null, /* Imports */[
  ...
  class _Serializer extends core.Object {
    /**
     * @constructor
     * @param {{serializeSendPorts: (*|undefined)}=} opts
     * @return {_Serializer}
     */
    _Serializer(opts) {
    ...
    /** @param {_native_typed_data.NativeByteBuffer} buffer */
    serializeByteBuffer(buffer) {
      return ["buffer", buffer];
    }
    /** @param {_native_typed_data.NativeTypedData} data */
    serializeTypedData(data) {
      return ["typed", data];
    }
    /** @param {_interceptors.JSIndexable} indexable */
    ...
    /** @param {_interceptors.JSObject} x */
    serializeJSObject(x) {
    ...
    /** @param {CapabilityImpl} x */
    serializeCapability(x) {
      return ['capability', x[_id]];
    }
    /** @param {core.Function} x */
    serializeClosure(x) {
  ...
  class _Deserializer extends core.Object {
    /**
     * @constructor
     * @param {{adjustSendPorts: (*|undefined)}=} opts
    ...
    /** @return {_native_typed_data.NativeByteBuffer} */
    ...
    /** @return {_native_typed_data.NativeTypedData} */
  ...
  class _IsolateContext extends core.Object {
    ...
    /**
     * @param {isolate.Capability} authentification
     * @param {isolate.Capability} resume
     */
    ...
    /** @param {isolate.SendPort} responsePort */
  ...
  class IsolateNatives extends core.Object {
    ...
    /**
     * @param {function(*)} topLevelFunction
     ...
     * @param {?boolean} isSpawnUri
     * @param {?boolean} startPaused
     * @param {isolate.SendPort} replyPort
    ...
    /**
     * @param {core.Function} topLevel
     * @param {core.List} args
     * @param {?boolean} isSpawnUri
     * @param {?boolean} startPaused
     * @param {isolate.SendPort} replyTo
     */
  ...
  class _NativeJsSendPort extends _BaseSendPort {
    /**
     * @constructor
     * @param {RawReceivePortImpl} _receivePort
     * @param {?number} isolateId
  ...
  class RawReceivePortImpl extends core.Object {
    ...
    /** @param {core.Function} newHandler */
  ...
  class ReceivePortImpl extends async.Stream {
    ...
    /**
     * @constructor
     * @param {isolate.RawReceivePort} _rawPort
     * @return {ReceivePortImpl}
     */
     ...
     * @return {async.StreamSubscription}
     */
    listen(onData, opts) {
  ...
  class TimerImpl extends core.Object {
     ...
     * @constructor
     * @param {?number} milliseconds
     * @param {function(async.Timer)} callback
     * @return {TimerImpl}
     */
