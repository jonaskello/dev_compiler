dart_library.library('dart/_js_helper', null, /* Imports */[
  ...
  class JsName extends core.Object {
    /**
     * @constructor
     * @param {{name: (string|undefined)}=} opts
     * @return {JsName}
     */
    JsName(opts) {
  ...
  class _MatchImplementation extends core.Object {
    /**
     * @constructor
     * @param {core.Pattern} pattern
     * @param {core.List} _match
  ...
  class Primitives extends core.Object {
     ...
     * @param {string} source
     * @param {?number} radix
     * @param {function(string):?number} handleError
     * @return {?number}
     */
  ...
  class TypeErrorImplementation extends core.Error {
     ...
     * @param {string} type
     * @return {TypeErrorImplementation}
     */
  ...
  class CastErrorImplementation extends core.Error {
    /**
     * @constructor
     * @param {core.Object} actualType
     * @param {core.Object} expectedType
     * @return {CastErrorImplementation}
     */
  ...
  class FallThroughErrorImplementation extends core.FallThroughError {
    /**
     * @constructor
     * @return {FallThroughErrorImplementation}
     */
