dart_library.library('dart/mirrors', null, /* Imports */[
  ...
  class MirrorsUsed extends core.Object {
    /**
     * @constructor
     * @param {{symbols: (*|undefined), targets: (*|undefined), metaTargets: (*|undefined), override: (*|undefined)}=} opts
     * @return {MirrorsUsed}
     */
    MirrorsUsed(opts) {
