dart_library.library('dart/collection', null, /* Imports */[
  ...
  let HashMap$ = dart.generic(function(K, V) {
    class HashMap extends core.Object {
      /**
       * @param {{equals: (function(*, *):?boolean|undefined), hashCode: (function(*):?number|undefined), isValidKey: (function(core.Object):?boolean|undefined)}=} opts
       * @return {HashMap}
       */
      static new(opts) {
       ...
       * @param {{key: (function(*):*|undefined), value: (function(*):*|undefined)}=} opts
       * @return {HashMap}
       */
      ...
      /**
       * @param {core.Iterable} keys
       * @param {core.Iterable} values
       * @return {HashMap}
       */
  ...
  let ListMixin$ = dart.generic(function(E) {
    class ListMixin extends core.Object {
       ...
       * @param {?number} start
       * @param {?number} end
       * @param {core.Iterable} newContents
       */
  ...
  let DoubleLinkedQueueEntry$ = dart.generic(function(E) {
    class DoubleLinkedQueueEntry extends core.Object {
      ...
      /**
       * @param {DoubleLinkedQueueEntry} previous
       * @param {DoubleLinkedQueueEntry} next
       */
      [_link](previous, next) {
  ...
  let DoubleLinkedQueue$ = dart.generic(function(E) {
    class DoubleLinkedQueue extends IterableBase$(E) {
      ...
      /** @param {function(DoubleLinkedQueueEntry)} f */
      forEachEntry(f) {
  ...
  let _DoubleLinkedQueueIterator$ = dart.generic(function(E) {
    class _DoubleLinkedQueueIterator extends core.Object {
      /**
       * @constructor
       * @param {_DoubleLinkedQueueEntrySentinel} sentinel
       * @return {_DoubleLinkedQueueIterator}
       */
  ...
  let ListQueue$ = dart.generic(function(E) {
    class ListQueue extends IterableBase$(E) {
      ...
      /** @param {?number} expectedModificationCount */
  ...
  let SplayTreeMap$ = dart.generic(function(K, V) {
    class SplayTreeMap extends _SplayTree$(K) {
       ...
       * @constructor
       * @param {function(*, *):?number=} compare
       * @param {function(core.Object):?boolean=} isValidKey
       * @return {SplayTreeMap}
       */
      ...
      /**
       * @param {core.Iterable} iterable
       * @param {{key: (function(*):*|undefined), value: (function(*):*|undefined), compare: (function(*, *):?number|undefined), isValidKey: (function(core.Object):?boolean|undefined)}=} opts
       * @return {SplayTreeMap}
       */
      static fromIterable(iterable, opts) {
        let key = opts && 'key' in opts ? opts.key : null;
  ...
  let _SplayTreeIterator$ = dart.generic(function(T) {
    class _SplayTreeIterator extends core.Object {
      ...
      /** @param {_SplayTreeNode} currentNode */
  ...
  let _CustomHashMap$ = dart.generic(function(K, V) {
    class _CustomHashMap extends _HashMap$(K, V) {
      /**
       * @constructor
       * @param {function(*, *):?boolean} _equals
       * @param {function(*):?number} _hashCode
       * @param {function(core.Object):?boolean} validKey
  ...
  let _LinkedIdentityHashMap$ = dart.generic(function(K, V) {
    class _LinkedIdentityHashMap extends _LinkedHashMap$(K, V) {
      /** @constructor @extends {_LinkedHashMap} */
  ...
  let _CustomHashSet$ = dart.generic(function(E) {
    class _CustomHashSet extends _HashSet$(E) {
      /**
       * @constructor
       * @param {function(*, *):?boolean} _equality
       * @param {function(*):?number} _hasher
       * @param {function(core.Object):?boolean} validKey
  ...
  let _LinkedIdentityHashSet$ = dart.generic(function(E) {
    class _LinkedIdentityHashSet extends _LinkedHashSet$(E) {
      /** @constructor @extends {_LinkedHashSet} */
