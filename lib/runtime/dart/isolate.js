dart_library.library('dart/isolate', null, /* Imports */[
  ...
  class Isolate extends core.Object {
    /**
     * @constructor
     * @param {SendPort} controlPort
     * @param {{pauseCapability: (Capability|undefined), terminateCapability: (Capability|undefined)}=} opts
     * @return {Isolate}
     */
    ...
    /**
     * @param {function(*)} entryPoint
     * @param {{paused: (?boolean|undefined)}=} opts
     * @return {async.Future}
     */
     ...
     * @param {{paused: (?boolean|undefined), packageRoot: (core.Uri|undefined)}=} opts
     * @return {async.Future}
     */
    ...
    /**
     * @param {Capability=} resumeCapability
     * @return {Capability}
     */
